...
void _interrupt _far newtimer()
{
   ...
   //char str[81];
   //sprintf(str,"FEDCBA9876543210, in A1h=%2.2Xh, in 21h=%2.2Xh, (int 70-77,08-0F)\n",inp(IMR2),inp(IMR1));
   //PutFrameCharsAttr(0,0,0,str,strlen(str),0x4F);
   for (i=0x0F;i>=0x00;i--) PutFrameCharsAttr(0,0,0,IRQEnabled(i)?"E":"M",1,0x4F);
   ...
   for (i = 0; i < strlen(tempstr); i++) *(pvga+i) = 0x1700 + tempstr[i];
